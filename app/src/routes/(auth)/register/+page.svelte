<script lang="ts">
	...
	import UserRegisterForm from './user-register-form.svelte';
	...
	<div class="lg:p-8">
		<div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
			<div class="flex flex-col space-y-2 text-center">
				...
				<p class="text-sm text-muted-foreground">Register with your email or Github</p>
			</div>
			<UserRegisterForm form={data.form} />
