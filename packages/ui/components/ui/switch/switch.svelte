...
>
	<SwitchPrimitive.Thumb
		class={cn(
			`pointer-events-none block h-4 w-4 rounded-full bg-background transition-all 
			data-[state=checked]:translate-x-5 data-[state=checked]:shadow-[0_0px_5px_0px_rgba(0,0,0,1)]
