...
<Command.Group heading="Layouts">
    <Command.Item onSelect={() => handleItemSelect(() => listLayout.set('grid'))} value="grid">
    ...
    <Command.Item onSelect={() => handleItemSelect(() => listLayout.set('list'))} value="list">
    ...
    <Command.Item onSelect={() => handleItemSelect(() => listLayout.set('masonry'))} value="masonry">
