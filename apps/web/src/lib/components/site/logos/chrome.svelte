...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class={className} viewBox="0 0 48 48">
	<defs>
	...
	<use xlink:href="#p" fill="#fbbc04" transform="rotate(-120 24 24)"/>
